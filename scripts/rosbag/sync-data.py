...
for i in range(1, 24):
    ...
    M = np.column_stack((t, zero + 34, g[0], g[1], g[2], a[0], a[1], a[2], zero, zero))
    ...
    Mkit = np.column_stack((t, zero + 7, np.arange(len(zero)), v[0], v[1], v[2], v[3], v[4], v[5], v[6]))

    # combine imu and arkit, then sort to time vector
